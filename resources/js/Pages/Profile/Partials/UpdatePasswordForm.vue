  ...
  <FormSection @submitted="updateProfilePassword">
    ...
    <template #form>
      ...
      <div class="col-span-6 sm:col-span-4">
        ...
        <CInput id="password" ref="passwordInput" v-model="form.password" type="password" class="mt-1 block w-full" autocomplete="new-password" />
        <CInputError :message="form.errors.password" class="mt-2" />
      </div>

      <div class="col-span-6 sm:col-span-4">
        <CLabel for="password_confirmation" value="Confirm Password" />
        <CInput id="password_confirmation" v-model="form.password_confirmation" type="password" class="mt-1 block w-full" autocomplete="new-password" />
